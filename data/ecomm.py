from data.utils import time_select_edge_time as time_select
...
from data.utils import time_merge_edge_time
...
class EcommUniDataset:
    def __init__(
        ...
        datas = [time_select(dataset, i) for i in years]  
        eval_datas = [get_eval_data(data) for data in datas]  
